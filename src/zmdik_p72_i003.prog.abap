    ...
    case gv_proc_type.
      when '1'. " Int Comp EFT
        if screen-name = 'GV_SND_NAME'
          ...
          or screen-name = 'GV_SND_PB'
          or screen-name = 'GV_RVC_PB'.
          screen-input = '0'.
          modify screen.
        endif.
      when '2'.   "Int Comp Havale
        if screen-name = 'GV_SND_NAME'
          or screen-name = 'GV_SND_IBAN'
          or screen-name = 'GV_RVC_NAME'
          or screen-name = 'GV_RVC_AMOUNT'
      ...
      when '5'. "FX-Spot
        ...
        if screen-name = 'GV_FX_IBAN'
          or screen-name = 'GV_FX_IBAN2'
          or screen-name = 'GV_FX_AMOUNT_TRANS'
          or screen-name = 'GV_FX_PB'
          or screen-name = 'GV_FX_PB_TRANS'
...
if qe_alv_report   is initial.
    create object qe_alv_report.
  endif.
  qe_alv_report->alv_display( ).
endmodule.
