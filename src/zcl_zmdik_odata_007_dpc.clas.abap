class ZCL_ZMDIK_ODATA_007_DPC definition
  public
...
protected section.
  ...
  methods MUTABAKATSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZMDIK_ODATA_007_MPC=>TS_MUTABAKAT
    raising
  ...
  methods MUTABAKATSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZMDIK_ODATA_007_MPC=>TT_MUTABAKAT
...
CLASS ZCL_ZMDIK_ODATA_007_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 27.02.2025 14:20:05 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZMDIK_ODATA_007_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA mutabakatset_create_entity TYPE zcl_zmdik_odata_007_mpc=>ts_mutabakat.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mutabakatset_get_entity TYPE zcl_zmdik_odata_007_mpc=>ts_mutabakat.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZMDIK_ODATA_007_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA mutabakatset_get_entityset TYPE zcl_zmdik_odata_007_mpc=>tt_mutabakat.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA mutabakatset_update_entity TYPE zcl_zmdik_odata_007_mpc=>ts_mutabakat.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*  Data declaration
*-------------------------------------------------------------
 DATA es_data TYPE zif_zmdik_update2=>zmdik_odata_str.
 DATA iv_record_id TYPE zif_zmdik_update2=>num10.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
 DATA ls_request_input_data TYPE zcl_zmdik_odata_007_mpc=>ts_mutabakat.
...
* Map request input fields to function module parameters
 iv_record_id = ls_request_input_data-id.
 es_data-description = ls_request_input_data-description.
 es_data-agreement_sts = ls_request_input_data-agreement_sts.
 es_data-upb_waers = ls_request_input_data-upb_waers.
 es_data-upb_balance = ls_request_input_data-upb_balance.
 es_data-stcd1 = ls_request_input_data-stcd1.
 es_data-monat = ls_request_input_data-monat.
 es_data-gjahr = ls_request_input_data-gjahr.
 es_data-authorizedp = ls_request_input_data-authorizedp.
 es_data-rec_mail = ls_request_input_data-rec_mail.
 es_data-email = ls_request_input_data-email.
 es_data-uname = ls_request_input_data-uname.
 es_data-name1 = ls_request_input_data-name1.
 es_data-butxt = ls_request_input_data-butxt.
 es_data-bukrs = ls_request_input_data-bukrs.
 es_data-kunnr = ls_request_input_data-kunnr.
 es_data-id = ls_request_input_data-id.
...
* Create key table for the read operation
 ...
 ls_key-name = 'ID'.
 ls_key-value = iv_record_id.
 IF ls_key-value IS NOT INITIAL.
   APPEND ls_key TO lt_keys.
 ENDIF.

 ls_key-name = 'ID'.
 ls_key-value = es_data-id.
...
*  Data declaration
*-------------------------------------------------------------
 DATA es_table TYPE zif_zmdik_get_all=>zmdik_odata_str.
 DATA iv_record_id TYPE zif_zmdik_get_all=>num10.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
...
* Maps key fields to function module parameters
 ...
 IF lv_source_entity_set_name = 'mutabakatSet' AND
 ...
 iv_record_id = ls_converted_keys-id.
* Get RFC destination
 lo_dp_facade = /iwbep/if_mgw_conv_srv_runtime~get_dp_facade( ).
 lv_destination = /iwbep/cl_sb_gen_dpc_rt_util=>get_rfc_destination( io_dp_facade = lo_dp_facade ).
...
* Map properties from the backend to the Gateway output response structure
 ...
 er_entity-id = es_table-id.
 er_entity-kunnr = es_table-kunnr.
 er_entity-bukrs = es_table-bukrs.
 er_entity-butxt = es_table-butxt.
 er_entity-name1 = es_table-name1.
 er_entity-uname = es_table-uname.
 er_entity-email = es_table-email.
 er_entity-rec_mail = es_table-rec_mail.
 er_entity-authorizedp = es_table-authorizedp.
 er_entity-gjahr = es_table-gjahr.
 er_entity-monat = es_table-monat.
 er_entity-stcd1 = es_table-stcd1.
 er_entity-upb_balance = es_table-upb_balance.
 er_entity-upb_waers = es_table-upb_waers.
 er_entity-agreement_sts = es_table-agreement_sts.
 er_entity-description = es_table-description.
  endmethod.
...
*-------------------------------------------------------------
 DATA iv_record_id TYPE zif_zmdik_get_all=>num10.
 DATA et_table  TYPE zif_zmdik_get_all=>zmutabakatstr.
 DATA ls_et_table  TYPE LINE OF zif_zmdik_get_all=>zmutabakatstr.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
...
*  Only fields that were mapped will be delivered to the response table
   ls_gw_et_table-id = ls_et_table-id.
   ...
   ls_gw_et_table-uname = ls_et_table-uname.
   ls_gw_et_table-email = ls_et_table-email.
   ls_gw_et_table-rec_mail = ls_et_table-rec_mail.
   ls_gw_et_table-authorizedp = ls_et_table-authorizedp.
   ls_gw_et_table-gjahr = ls_et_table-gjahr.
   ls_gw_et_table-monat = ls_et_table-monat.
   ls_gw_et_table-stcd1 = ls_et_table-stcd1.
   ls_gw_et_table-upb_balance = ls_et_table-upb_balance.
   ls_gw_et_table-upb_waers = ls_et_table-upb_waers.
   ls_gw_et_table-agreement_sts = ls_et_table-agreement_sts.
   ls_gw_et_table-description = ls_et_table-description.
...
* Maps key fields to function module parameters
 ...
 iv_record_id = ls_converted_keys-id.
 es_data-id = ls_converted_keys-id.
* Map request input fields to function module parameters
 es_data-kunnr = ls_request_input_data-kunnr.
 es_data-bukrs = ls_request_input_data-bukrs.
 es_data-butxt = ls_request_input_data-butxt.
