...
LOOP AT gt_scarr into gs_scarr .
 CONCATENATE gs_scarr-carrid
            ...
            gs_scarr-url
            into gv_att_line
            SEPARATED BY cl_abap_char_utilities=>horizontal_tab.                    "tabloda hücrelere ayırması için sap da olan bi fonksiyonu kullanıyoruz.
          IF sy-tabix eq 1 .
...
go_doc_bcs->add_attachment(                                                         "mail içeriğine döküman eklemek için
  EXPORTING
