...
data:
  ...
  gv_doc_date    type zmdpfin_de037,
...
data: go_alv     type ref to cl_gui_alv_grid,
      go_rcv_alv type ref to cl_gui_alv_grid,
      go_cont    type ref to cl_gui_custom_container.

data: gv_qe_comp_code type zeho_t002-bukrs,
      gv_qe_date      type zmdpfin_de037,
      gv_qe_bank      type zeho_de001.

data: gt_data type standard table of zmdpfin_s003,
      gs_data type zmdpfin_s003.

data: gt_rcv_data type standard table of zmdpfin_s004,
      gs_rcv_data type zmdpfin_s004.

data: gv_qe_rcv_date type sy-datum,
      gv_qe_rcv_cc   type zeho_t002-bukrs,
      gv_qe_rcv_bank type zeho_de001,
      gv_qe_rcv_pb   type zeho_t002-waers.

class lcl_report definition deferred.
data: go_report type ref to lcl_report.

class: lcl_qe_report  definition deferred.
data: qe_alv_report type ref to lcl_qe_report .
