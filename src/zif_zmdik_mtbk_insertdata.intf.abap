interface ZIF_ZMDIK_MTBK_INSERTDATA
  public .
  ...
  types:
    HWAER type C length 000005 .
  types:
    SHKZG type C length 000001 .
  types:
    KTEXT_074T type C length 000007 .
  types:
    CHAR6 type C length 000006 .
  types:
  ...
  types:
    begin of ZMDIK_MUTAKABAT,
      ...
      UPB_PARA_BIRIMI type HWAER,
      DETAY type CHAR4,
      TARIH type DATS,
      BORC_ALACAK type SHKZG,
      K_TEXT type KTEXT_074T,
